...
conveyor_prim = "/World/conveyor"
conveyor_name = "my_conveyor"
conveyor_init_position = np.array([0, 0.20, 0])
conveyor_init_orientation = np.array([0, 0, 1.57])
conveyor_init_scale = np.array([0.001, 0.001, 0.001])
