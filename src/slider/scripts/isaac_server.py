...
import json
import actionlib
from isaac_interface import Slider_Isaac_Interface
...
class Slider_Isaac_Server():
    ...
    def __init__(self, ns):
        ...
        self.slider = Slider_Isaac_Interface(ns = self.ns)
        self.slider.run_simulation()
